...
text_generator = pipeline(
    ...
    model=model,
    tokenizer=tokenizer,
    max_new_tokens=60,  # Reduced from 128
...
new_data['llama4B_response']=gen_response
new_data['llama4B_f1_score']=f1_score
new_data['llama4B_EM_score']=EM_score
new_data['llama4B_cos_score']=cos_score

new_data.to_csv('baseline_scores_llama4BM25.csv', index=False)
